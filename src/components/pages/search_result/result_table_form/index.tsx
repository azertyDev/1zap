        ...
        <div className={s.table_wr}>
            <div className={s.table}>
                <div className={s.table_row}>
                    ...
                    <div className={`${s.table_el} ${s.table_h}`}>Номер</div>
                    <div className={`${s.table_el} ${s.table_h}`}>
                        Наименование
                    </div>
                    <div className={`${s.table_el} ${s.table_h}`}>Наличие</div>
                    <div className={`${s.table_el} ${s.table_h}`}>Цена</div>
                    <div className={`${s.table_el} ${s.table_h}`}>Продавец</div>
                </div>
                ...
                <div className={s.table_row}>
                    ...
                    <div className={`${s.table_el} ${s.table_b}`}>
                        ...
                        <p>
                            Обязательно получите подтверждение резерва на 1zap
                            или по звонку
                        </p>
                    </div>
                    <div className={`${s.table_el} ${s.table_b}`}>
